...
with open ('D:/vs_code/visualstudiocodes.github.io/python-codes/trading/text_documents/histrocial_data.txt','w') as file:
...
with open('D:/vs_code/visualstudiocodes.github.io/python-codes/trading/text_documents/close_price_list.txt','w') as file:
